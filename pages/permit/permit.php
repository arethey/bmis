                                            ...
                                            if(!isset($_SESSION['staff']))
                                            {
                                                ...
                                                while($row = mysqli_fetch_array($squery))
                                                {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a  href="print.php?resident='.$row['residentid'].'&permit='.$row['businessName'].'&val='.sha1($row['businessName'].'|'.$row['businessAddress'].'|'.$row['dateRecorded']).'" onclick="location.reload();" class="btn btn-primary btn-sm"><i class="fa fa-print" aria-hidden="true"></i>View Permit</a></td>
                                                    </tr>
                                                    ';
