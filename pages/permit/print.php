            ...
            <div style=" background: black;" >
                ...
                <div class="col-xs-7 col-sm-5 col-md-8" style="background: white;  ">
                    ...
                    <div class="col-xs-12 col-md-12">
                        <p class="text-center" style="font-size: 20px; font-size:bold;">OFFICE OF THE PUNONG BARANGAY <br><b style="font-size: 28px;">BARANGAY CLEARANCE FOR BUSINESS PERMIT </b></p>
                        ...
                        <?php
                            ...
                            if($row = mysqli_fetch_array($qry)) {
                                ...
                                echo '
                                <p><b>
                                    Barangay Clearance is hereby granted to  <u>'.strtoupper($row['fname']).'</u> <u>'.strtoupper($row['mname']).'</u> <u>'.strtoupper($row['lname']).'</u>owner of 
                                     <u>'.strtoupper($row['businessName']).'</u>, located at Baranga Tugas, Madridejos, Cebu<br>
                                    after fully complied with the existing barangay ordinance, rules and regulations being enforced in this barangay
                                </b></p>
                                
                                <p><b>
                                    &nbsp;&nbsp;&nbsp;This Clearance is issued upon request of the above named person for whatever legal purpose it may serve her/him best <br>
                                    
                                   Issued this <u>'.strtoupper(date_format($date,"F j, o")).'</u> day of <u>'.strtoupper(date_format($date,"F j, o")).'</u>  at Barangay Tugas, Madridejos <br>
                                </b></p>
                                ';
                            }
                        ?>
