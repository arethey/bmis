                    ...
                    <div class="box">
                        <div class="col-md-3 col-sm-6 col-xs-12"><br>
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    <span class="info-box-text">Total UnSolved Blotter</span>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12"><br>
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    <span class="info-box-text">Total Solved Blotter</span>
                                    <span class="info-box-number">
                                        <?php
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12"><br>
                            <div class="info-box">
                                <a href="../permit/permit.php"><span class="info-box-icon bg-aqua"><i
                                            class="fa fa-file"></i></span></a>
