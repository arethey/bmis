            ...
            <div style=" background: black;" >
                ...
                <div class="col-xs-7 col-sm-5 col-md-8" style="background: white;  ">
                    ...
                    <div class="col-xs-12 col-md-12">
                        <p class="text-center" style="font-size: 20px; font-size:bold;">OFFICE OF THE PUNONG BARANGAY <br><b style="font-size: 28px;">OFFICE OF THE LUPONG TAGAPAMAYAPA</b></p>
                        ...
                        <?php
                            ...
                            if($row = mysqli_fetch_array($qry)) {
                                ...
                                echo '
                                <p><b>
                                     Complainant: <u>'.strtoupper($row['complainant']).'</u><br> Against:<br>Respondent: <u>'.strtoupper($row['rname']).'</u> 
                                </b></p>
                                ...
                                <p><b>
                                  ...
                                  <center> <u>'.strtoupper(date_format($date,"F j, o")).'</u>, BARANGAY HALL</center> &nbsp;&nbsp;&nbsp;Then and there to answer to a complainant made before me, of which is attached hereto, for mediation of your dispute with complainant. <br><br>&nbsp;&nbsp;&nbsp; You are hereby warned that if you refuse or willfully fail to appear in obedience to this Summons, you may be barred from filing any counter claim arising from said complainant.<br><br>Fail not or else face punishment as of for contempt of court.
                                </b></p>
                                ';
                            }
                        ?>
