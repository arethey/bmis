                                            ...
                                            if(!isset($_SESSION['staff']))
                                            {
                                                ...
                                                while($row = mysqli_fetch_array($squery))
                                                {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a  href="printblotter.php?resident='.$row['bid'].'&blotter='.$row['complainant'].'&val='.sha1($row['complainant'].'|'.$row['personToComplain'].'|'.$row['dateRecorded']).'" onclick="location.reload();" class="btn btn-primary btn-sm"><i class="fa fa-print" aria-hidden="true"></i>View Blotter</a></td>
                                                    </tr>
                                                    ';
