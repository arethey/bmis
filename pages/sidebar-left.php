<?php
	...
	echo '
	<aside class="left-side sidebar-offcanvas" style="background:linear-gradient(to right, #33cccc, #00ffff);">
                <!-- sidebar: style can be found in sidebar.less -->
                <section class="sidebar">
                    <!-- Sidebar user panel -->
                    <div class="user-panel" style=" background:linear-gradient(to right, #0066ff, #0ed2f7);">
                    ...
                    if($_SESSION['role'] == "Administrator"){
                        echo '
                    <ul class="sidebar-menu" style="background:linear-gradient(to right, #0066ff, #003d99);">
                            <li>
