...
if (isset($_POST['reset-password'])) {
  ...
  if (count($errors) == 0) {
    ...
    $results = mysqli_query($db, $sql);// Send email to user with the token in a link they can click on
    $to = $email;
...
if (isset($_POST['new_password'])) {
  ...
  if (count($errors) == 0) { // select email address of user from the password_reset table 
